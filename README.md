...
### არქიტექტურა 2: PlainCNN — გადამეტებული მორგების (Overfitting) დემონსტრირება
...
| `reg_hp_search`    | reg                      | ჰიპერპარამეტრების ხელით ძიება RegCNN-ისთვის              |
| `resnet_hp_search` | resnet                   | ჰიპერპარამეტრების ხელით ძიება MiniResNet-ისთვის          |
